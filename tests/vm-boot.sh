...
setsid qemu-system-x86_64 \
  ...
  -append "archisobasedir=arch archisosearchuuid=$ISO_UUID cow_spacesize=10G quiet splash plymouth.ignore-serial-consoles module_blacklist=pcspkr i915.modeset=1 amdgpu.modeset=1 nvme_load=yes console=tty0 console=ttyS0" \
  -cdrom "$ISO" \
