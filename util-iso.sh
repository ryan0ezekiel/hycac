...
[38;2;236;236;241m  _   _  ____ ____  ____     _   _ [0m
[38;2;236;236;241m | | | |/ ___|  _ \|  _ \   / \ | | [0m
[38;2;236;236;241m | |_| | |   | |_) | |_) | / _ \| | [0m
[38;2;236;236;241m |  _  | |___|  _ <|  _ < / ___ \ |___[0m
[38;2;236;236;241m |_| |_|\____|_| \_\_| \_\/_/  \_\____|[0m

A light personal live environment - niri + Noctalia on CachyOS.

Pure live ISO: nothing is installed to any disk. Experiment freely,
everything is forgotten on reboot.

Tips:
  - fish shell is the default; 'micro' and 'vim' are available
  - octopi / gnome-software can install software at runtime
  - btrfs-assistant & gparted available for disk work

Welcome to your [38;2;23;147;209mHYCAC[0m!
...
[41m  [40m  [44m  [41m  [46m  [45m  [43m  [42m  [47m  [0m
EOF
    fi
}
...
generate_environment() {
    local _profile="$1"
    if [ "$_profile" == "desktop" ] || [ "$_profile" == "hycac" ]; then
...
prepare_profile(){
    ...
    elif [ "$profile" == "hycac" ]; then
        cp ${src_dir}/archiso/packages_hycac.x86_64 ${src_dir}/archiso/packages.x86_64
